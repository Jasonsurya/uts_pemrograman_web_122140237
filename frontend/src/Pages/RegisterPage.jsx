...
const RegisterForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        console.log("e.preventDefault() telah dipanggil. e.defaultPrevented:", e.defaultPrevented);
        ...
        // KOREKSI PENTING DI SINI: Targetkan BACKEND (port 6543)
        console.log("Mengirim request dengan method: POST, URL: http://localhost:6543/register, Body:", requestBody);

        try {
            const response = await fetch("http://localhost:6543/register", { // <--- KOREKSI URL INI
                method: "POST",
                headers: {
            ...
            console.log("Respon diterima. Status:", response.status, "URL:", response.url);
            ...
            console.error("Kesalahan jaringan (fetch gagal total):", err);
